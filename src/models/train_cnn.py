...
def main():
    ...
    generator = GenotypeMatrixGenerator(h5py.File(args.ifile, 'r'), padded_size = 2000)
    validation_generator = GenotypeMatrixGenerator(h5py.File(args.ifile_val, 'r'), padded_size = 2000)
    model = LexStyleNet()
    ...
    criterion = NLLLoss() #LabelSmoothing() #NLLLoss()
