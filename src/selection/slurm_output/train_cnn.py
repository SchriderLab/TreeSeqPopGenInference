...
import h5py
import configparser
from data_loaders import GenotypeMatrixGenerator,ResnetGenotypeMatrixGenerator
...
from layers import LexStyleNet,resnet18
...
def parse_args():
    ...
    parser.add_argument("--padding_size", default = "2000")
...
def main():
    ...
    generator = ResnetGenotypeMatrixGenerator(h5py.File(args.ifile, 'r'), padded_size = int(args.padding_size))
    validation_generator = ResnetGenotypeMatrixGenerator(h5py.File(args.ifile_val, 'r'), padded_size = int(args.padding_size))
    model = resnet18() #LexStyleNet()
    ...
    criterion = NLLLoss()  #LabelSmoothing() 
